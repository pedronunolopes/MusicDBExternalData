...
public final class ENt_MUArtistMediaEntity {
	...
	public static java.util.HashMap<String, String> attributesToDatabaseNamesMap() {
		return new java.util.HashMap<String, String>() {
			{
				put("mediaid", "MediaId"); put("artistid", "ArtistId"); put("mediatypeid", "MediaTypeId"); put("insertdate", "InsertDate"); put("updatedate", "UpdateDate"); 
			}
		};
	}
