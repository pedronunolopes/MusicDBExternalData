...
public final class ENt_MUEventEntity {
	...
	public static java.util.HashMap<String, String> attributesToDatabaseNamesMap() {
		return new java.util.HashMap<String, String>() {
			{
				put("eventid", "EventId"); put("eventtypeid", "EventTypeId"); put("name", "Name"); put("description", "Description"); put("venueid", "VenueId"); put("parenteventid", "ParentEventId"); put("city", "City"); put("date", "Date"); put("insertdate", "InsertDate"); put("updatedate", "UpdateDate"); 
			}
		};
	}
} // ENt_MUEventEntity
