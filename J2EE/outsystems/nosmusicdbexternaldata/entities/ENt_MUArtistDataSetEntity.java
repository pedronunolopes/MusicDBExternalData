...
public final class ENt_MUArtistDataSetEntity {
	...
	public static java.util.HashMap<String, String> attributesToDatabaseNamesMap() {
		return new java.util.HashMap<String, String>() {
			{
				put("artistid", "ArtistId"); put("datasetid", "DataSetId"); put("version", "Version"); put("insertdate", "InsertDate"); put("updatedate", "UpdateDate"); 
			}
		};
	}
