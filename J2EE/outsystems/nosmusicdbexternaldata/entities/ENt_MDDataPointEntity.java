...
public final class ENt_MDDataPointEntity {
	...
	public static java.util.HashMap<String, String> attributesToDatabaseNamesMap() {
		return new java.util.HashMap<String, String>() {
			{
				put("datapointtypeid", "DatapointTypeId"); put("name", "Name"); put("description", "Description"); put("insertdate", "InsertDate"); put("updatedate", "UpdateDate"); 
			}
		};
	}
