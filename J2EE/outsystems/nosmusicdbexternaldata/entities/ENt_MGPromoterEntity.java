...
public final class ENt_MGPromoterEntity {
	...
	public static java.util.HashMap<String, String> attributesToDatabaseNamesMap() {
		return new java.util.HashMap<String, String>() {
			{
				put("promoterid", "PromoterId"); put("name", "Name"); put("description", "Description"); put("countryid", "CountryId"); put("insertdate", "InsertDate"); put("updatedate", "UpdateDate"); 
			}
		};
	}
