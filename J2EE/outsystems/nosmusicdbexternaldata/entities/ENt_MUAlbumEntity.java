...
public final class ENt_MUAlbumEntity {
	...
	public static java.util.HashMap<String, String> attributesToDatabaseNamesMap() {
		return new java.util.HashMap<String, String>() {
			{
				put("albumid", "AlbumId"); put("name", "Name"); put("description", "Description"); put("releasedate", "ReleaseDate"); put("unitssold", "UnitsSold"); put("insertdate", "InsertDate"); put("updatedate", "UpdateDate"); 
			}
		};
	}
} // ENt_MUAlbumEntity
