...
@outsystems.hubedition.runtimeplatform.metainformation.EntityRecordDetails(name = "t_MDSocialMedia", key = "o2TKnjx09UyJpCE2MIgQzg", ownerKey = "oJe9tylD_EGUBlO4A46FUA", generation = 0, physicalTableName = "[dbo].[t_MDSocialMedia]", dbConnection = "")
public final class ENt_MDSocialMediaEntityRecord implements Serializable, Cloneable, ITypedRecord<ENt_MDSocialMediaEntityRecord>, ISimpleRecord {

	private static final GlobalObjectKey IdSocialMediaId = GlobalObjectKey.parse("oJe9tylD_EGUBlO4A46FUA*jnk3F8RBl0qqyS_ePPmONg");
	private static final GlobalObjectKey IdName = GlobalObjectKey.parse("oJe9tylD_EGUBlO4A46FUA*Q0Eg4nCdKkijWwqmlaTAgw");
	private static final GlobalObjectKey IdDescription = GlobalObjectKey.parse("oJe9tylD_EGUBlO4A46FUA*5rpY1g2og0KlQcsYKtqXIA");
	private static final GlobalObjectKey IdInsertDate = GlobalObjectKey.parse("oJe9tylD_EGUBlO4A46FUA*FWjLdxdPZ0ic0PD2va8d8w");
	private static final GlobalObjectKey IdUpdateDate = GlobalObjectKey.parse("oJe9tylD_EGUBlO4A46FUA*FLy5nJ+eMkyKQpw4pk3wjQ");

	public static void ensureInitialized() {}
	@outsystems.hubedition.runtimeplatform.metainformation.EntityAttributeDetails(name= "SocialMediaId", length=0, isAutonumber=true, isPrimaryKey=true, isEntityReference=false, isMandatory=true)
	private int _ssSocialMediaId;
	public int getSsSocialMediaId() {
		return _ssSocialMediaId;
	}
	public void setSsSocialMediaId(int value) {
		if ((_ssSocialMediaId != value) || OptimizedAttributes.get(0)) {
			ChangedAttributes = BitSetUtils.newInstance(5, true);
			_ssSocialMediaId = value;
		}
	}

	@outsystems.hubedition.runtimeplatform.metainformation.EntityAttributeDetails(name= "Name", length=50, isAutonumber=false, isPrimaryKey=false, isEntityReference=false, isMandatory=true)
	 ...
	 * Default Constructor
	 */
	public ENt_MDSocialMediaEntityRecord() {
		ChangedAttributes = BitSetUtils.newInstance(5, true);
	 ...
	 */
	public RCt_MDSocialMediaRecord toRecord() {
		try {
			return new RCt_MDSocialMediaRecord(this);
		} catch (Exception e) {
	...
	public int read(OSResultSet r, int index) throws ClassCastException {
		setSsSocialMediaId(DataReaderUtils.readInteger(r, index++, "t_MDSocialMedia.SocialMediaId", 0));
		setSsName(DataReaderUtils.readText(r, index++, "t_MDSocialMedia.Name", ""));
		setSsDescription(DataReaderUtils.readText(r, index++, "t_MDSocialMedia.Description", ""));
		setSsInsertDate(DataReaderUtils.readDateTime(r, index++, "t_MDSocialMedia.InsertDate", new DateTime(1900, 1, 1, 0, 0, 0)));
		setSsUpdateDate(DataReaderUtils.readDateTime(r, index++, "t_MDSocialMedia.UpdateDate", new DateTime(1900, 1, 1, 0, 0, 0)));
	 ...
	 *         Record
	 */
	public void readIM(ENt_MDSocialMediaEntityRecord r) throws Exception {
	...
	public boolean equals(Object obj) {
		if ((obj == null) || !(obj instanceof ENt_MDSocialMediaEntityRecord)) {
			return false;
		}
		ENt_MDSocialMediaEntityRecord b = (ENt_MDSocialMediaEntityRecord) obj;
	 ...
	 */
	public ENt_MDSocialMediaEntityRecord duplicate() throws Exception {
		ENt_MDSocialMediaEntityRecord t = new ENt_MDSocialMediaEntityRecord();
	...
	public Object clone() throws CloneNotSupportedException {
		ENt_MDSocialMediaEntityRecord t = (ENt_MDSocialMediaEntityRecord) super.clone();
		return t;
	}
	...
	public void fillFromOther(IRecord other) throws Exception {
		...
		ChangedAttributes.set(0, other.changedAttributeGet(IdSocialMediaId));
		OptimizedAttributes.set(0, other.optimizedAttributeGet(IdSocialMediaId));
