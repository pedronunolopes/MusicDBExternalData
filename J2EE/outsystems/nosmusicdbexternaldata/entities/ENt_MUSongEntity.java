...
public final class ENt_MUSongEntity {
	...
	public static java.util.HashMap<String, String> attributesToDatabaseNamesMap() {
		return new java.util.HashMap<String, String>() {
			{
				put("songid", "SongId"); put("name", "Name"); put("length", "Length"); put("releasedate", "ReleaseDate"); put("weeksincharts", "WeeksInCharts"); put("insertdate", "InsertDate"); put("updatedate", "UpdateDate"); 
			}
		};
	}
} // ENt_MUSongEntity
