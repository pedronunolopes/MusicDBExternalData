...
public final class ENt_MDDataSetEntity {
	...
	public static java.util.HashMap<String, String> attributesToDatabaseNamesMap() {
		return new java.util.HashMap<String, String>() {
			{
				put("datasettypeid", "DataSetTypeId"); put("name", "Name"); put("description", "Description"); put("insertdate", "InsertDate"); put("updatedate", "UpdateDate"); 
			}
		};
	}
} // ENt_MDDataSetEntity
