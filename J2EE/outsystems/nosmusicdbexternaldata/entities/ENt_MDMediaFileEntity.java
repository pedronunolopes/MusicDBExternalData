...
public final class ENt_MDMediaFileEntity {
	...
	public static java.util.HashMap<String, String> attributesToDatabaseNamesMap() {
		return new java.util.HashMap<String, String>() {
			{
				put("mediafiletypeid", "MediaFileTypeId"); put("name", "Name"); put("description", "Description"); put("insertdate", "InsertDate"); put("updatedate", "UpdateDate"); 
			}
		};
	}
