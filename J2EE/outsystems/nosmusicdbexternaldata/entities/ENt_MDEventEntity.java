...
public final class ENt_MDEventEntity {
	...
	public static java.util.HashMap<String, String> attributesToDatabaseNamesMap() {
		return new java.util.HashMap<String, String>() {
			{
				put("eventtypeid", "EventTypeId"); put("name", "Name"); put("description", "Description"); put("insertdate", "InsertDate"); put("updatedate", "UpdateDate"); 
			}
		};
	}
} // ENt_MDEventEntity
