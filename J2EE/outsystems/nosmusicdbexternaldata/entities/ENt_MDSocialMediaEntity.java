...
public final class ENt_MDSocialMediaEntity {
	...
	public static java.util.HashMap<String, String> attributesToDatabaseNamesMap() {
		return new java.util.HashMap<String, String>() {
			{
				put("socialmediaid", "SocialMediaId"); put("name", "Name"); put("description", "Description"); put("insertdate", "InsertDate"); put("updatedate", "UpdateDate"); 
			}
		};
	}
